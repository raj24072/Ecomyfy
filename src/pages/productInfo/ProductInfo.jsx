      ...
      <div className="container px-5 py-32 mx-auto">
        {products && (
          <div className="lg:w-4/5 flex flex-wrap mx-auto">
            ...
            {/* image column end*/}
            {/* Details card here*/}
            <div className="w-full lg:w-1/2 lg:h-auto lg:pl-10 mt-6 lg:mt-0">
              <h2
              ...
              <div className="flex">
                ...
                <button onClick={() => addCart(products)} className="flex ml-auto text-indigo-500 border-0 py-2 px-6 focus:outline-none hover:text-white hover:bg-indigo-600 rounded">
                  Add To Cart
                </button>
